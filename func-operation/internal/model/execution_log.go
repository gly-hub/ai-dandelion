...
type FunctionExecutionLog struct {
	...
	RequestID      string `gorm:"column:request_id;type:varchar(64);not null;default:'';index;comment:外层请求UUID"`
	InvocationType string `gorm:"column:invocation_type;type:varchar(24);not null;index;comment:preview/published"`
