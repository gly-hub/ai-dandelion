...
type Function struct {
	...
	TechnicalDraftOperationID     string `gorm:"column:technical_draft_operation_id;type:varchar(36);not null;default:'';index;comment:生成当前研发文档草稿的会话操作ID"`
	TechnicalSourceProductVersion int64  `gorm:"column:technical_source_product_version;type:bigint;not null;default:0;comment:已应用研发文档引用的产品文档版本"`
	...
	CodeDraftOperationID          string `gorm:"column:code_draft_operation_id;type:varchar(36);not null;default:'';index;comment:生成当前代码草稿的会话操作ID"`
	CodeSourceTechnicalVersion    int64  `gorm:"column:code_source_technical_version;type:bigint;not null;default:0;comment:已应用代码引用的研发文档版本"`
