...
func (f *Function) Update(ctx context.Context, function *model.Function) error {
	return f.db.WithContext(ctx).
		...
		Updates(map[string]any{
			...
			"technical_draft_operation_id":     function.TechnicalDraftOperationID,
			"technical_source_product_version": function.TechnicalSourceProductVersion,
			"code_version":                     function.CodeVersion,
			"code_draft_version":               function.CodeDraftVersion,
			"code_draft_operation_id":          function.CodeDraftOperationID,
			"code_source_technical_version":    function.CodeSourceTechnicalVersion,
